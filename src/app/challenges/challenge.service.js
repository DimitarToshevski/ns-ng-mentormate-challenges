...
var ChallengeService = /** @class */ (function () {
    ...
    ChallengeService.prototype.fetchCurrentChallenge = function () {
        ...
        return this.authService.user.pipe(operators_1.take(1), operators_1.switchMap(function (currentUser) {
            ...
            console.log("https://ns-ng-mentormate-challenges.firebaseio.com/challenge/" + currentUser.id + ".json?auth=" + currentUser.token);
            return _this.http.get("https://ns-ng-mentormate-challenges.firebaseio.com/challenge/" + currentUser.id + ".json?auth=" + currentUser.token);
    ...
    ChallengeService.prototype.saveToServer = function (challenge) {
        ...
        this.authService.user
            ...
            return _this.http.put("https://ns-ng-mentormate-challenges.firebaseio.com/challenge/" + currentUser.id + ".json?auth=" + currentUser.token, challenge);
        }))
